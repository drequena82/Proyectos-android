...
import com.libgdxexamples.samples.graphics.Planet;

public class GenerateCircleOnTouch extends ApplicationAdapter
{

    private final float PIXELS_TO_METERS = 100f;
    private Border floor;
    private ArrayList<Planet> listPlayer;
    private World world;
	...
	listPlayer = new ArrayList<Planet>();
	...
	floor = new Border(world, 0.75f, screenWidth, screenHeigth,
	...
	if (Gdx.input.isTouched())
	{
	    ...
	    {
		planet = new Planet(world, 15, 0.5f, 0.5f, touchPos.x,
			touchPos.y);
	...
	for (Planet player : listPlayer)
	{
	    player.renderPlanet(batch, true);
	}
